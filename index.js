...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
			client.updatePresence(from, Presence.composing)
			reply("teu pai aquele Veio Vagabundo")
				}
	
	if (messagesC.includes("bosta")){
			client.updatePresence(from, Presence.composing)
			reply("quer chamar aten莽茫o? Manda A Foto Da Bct Da Tua Mae")
	}
	
		if (messagesC.includes("corno")){
			client.updatePresence(from, Presence.composing)
			reply("Teu Pai Aquele Boi?")
	}
		...
		if (messagesC.includes("bot")){
			client.updatePresence(from, Presence.composing)
			reply("roi, Vai Me Da O Bumbum?馃ズ鉂わ笍")
	}
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/Chiquinhojokes.js');
...
// recursos anime, random @Chiquinho domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *ADMINBOT Chiquinho 鉁�* 銆峔n*鈹�+ wa.me/554184537851*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *Chiquinho* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER ADMIN DO BOT Chiquinho_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '锔�*canal do Chiquinho:*\n\n https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
